...
---@return function
IterTools.iter = function(iterable)
  ...
  elseif type(iterable) == "table" then
    ...
    elseif compat.is_list(iterable) then
      ...
      return IterTools.iter(vim.tbl_keys(iterable))
    end
  else
...
---@param iterable table|string|function
---@return function
IterTools.enumerate = function(iterable)
  local iterator = IterTools.iter(iterable)
  local i = 0
...
---@return function
IterTools.zip = function(iterable1, iterable2)
  local iterator1 = IterTools.iter(iterable1)
  local iterator2 = IterTools.iter(iterable2)
